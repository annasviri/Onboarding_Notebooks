...
# MAGIC * Grant and revoke access to Data and AI objects.
...
# MAGIC anna_sviridova_2nsm_da

# COMMAND ----------

# MAGIC %md
# MAGIC ### Granting Permissions on Tables
# MAGIC Now that we have created a bronze table, which contains the raw data we ingested from the data file(s), and we have our silver table, which we can use to clean the data and make it ready for use, let's share the silver table with other users on our team in Databricks. We do this using the Catalog Explorer.

# COMMAND ----------

# MAGIC %md
# MAGIC ### The Catalog Explorer
# MAGIC To view the Catalog Explorer, right-click on **Catalog** in the left sidebar menu, and open the link in a new tab.  
# MAGIC   
# MAGIC Drill open the catalog name in the list of data assets on the left side of the Catalog Explorer. The name of your catalog is listed in the output of the previous cell. If you do not see the name of your catalog in the Catalog Explorer, run the previous lesson's notebook in its entirety, and start this lesson over.  
# MAGIC   
...
# MAGIC Click the table `customers_silver_merged`. We see the column information for this table. Note we can also view sample data, details, permissions, history, lineage, insights and Quality.
# MAGIC   
# MAGIC Click **Permissions**. We can grant and revoke permissions on this table using this tab.  
# MAGIC   
# MAGIC Click the **Grant** button.  
# MAGIC   
# MAGIC Click inside the **Principals** dropdown to open the list. Note that you can grant permissions to individual users, groups, and service principles.  
# MAGIC   
...
# MAGIC Click the **Grant** button.  
# MAGIC   
# MAGIC Click inside the **Principals** dropdown to open the list. Choose a group from the list. There may not be many groups in your workspace, but there will always be either an **Account Users** or a **Users** group. Choose one of these groups and close the dropdown list using the `ESC` key on your keyboard.  
# MAGIC   
