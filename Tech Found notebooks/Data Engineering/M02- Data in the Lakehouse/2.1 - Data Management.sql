...
-- MAGIC %python
-- MAGIC display(dbutils.fs.ls("/mnt/dbacademy-datasets/get-started-with-data-engineering-on-databricks/v01"))
-- MAGIC

-- COMMAND ----------

-- MAGIC %python
-- MAGIC display(dbutils.fs.ls("/mnt/dbacademy-datasets/get-started-with-data-engineering-on-databricks/v01/customers_delta/"))
...
SELECT * FROM getting_started.customers_bronze;
