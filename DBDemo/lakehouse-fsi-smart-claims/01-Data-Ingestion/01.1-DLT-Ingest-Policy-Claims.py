...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=lakehouse&org_id=1444828305810485&notebook=%2F01-Data-Ingestion%2F01.1-DLT-Ingest-Policy-Claims&demo_name=lakehouse-fsi-smart-claims&event=VIEW&path=%2F_dbdemos%2Flakehouse%2Flakehouse-fsi-smart-claims%2F01-Data-Ingestion%2F01.1-DLT-Ingest-Policy-Claims&version=1">

# COMMAND ----------

# MAGIC %md  
# MAGIC
# MAGIC This demo started for you a <a dbdemos-pipeline-id="dlt-fsi-smart-claims" href="#joblist/pipelines/41cf05ee-2202-4faa-a838-16f4af3b8b96" target="_blank">DLT Pipeline</a> using this notebook! Explore it to see its execution out of the box.
