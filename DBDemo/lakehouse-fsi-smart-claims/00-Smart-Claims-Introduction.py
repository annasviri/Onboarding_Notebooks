...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=lakehouse&org_id=1444828305810485&notebook=%2F00-Smart-Claims-Introduction&demo_name=lakehouse-fsi-smart-claims&event=VIEW&path=%2F_dbdemos%2Flakehouse%2Flakehouse-fsi-smart-claims%2F00-Smart-Claims-Introduction&version=1">
...
# MAGIC
# MAGIC This will create a <a dbdemos-pipeline-id="dlt-fsi-smart-claims" href="#joblist/pipelines/41cf05ee-2202-4faa-a838-16f4af3b8b96" target="_blank">DLT Pipeline</a> running in batch or streaming.
# MAGIC
...
# MAGIC %md
# MAGIC Open the [04-Workflow-Orchestration]($./04-Workflow-Orchestration/04-Workflow-Orchestration-Smart-Claims)  notebook to schedule or <a dbdemos-workflow-id="init-job" href="#job/992554426921401/tasks" target="_blank">access your workflow</a> (data ingetion, model re-training, dashboard update etc)
