...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=lakehouse&org_id=1444828305810485&notebook=%2F04-Workflow-Orchestration%2F04-Workflow-Orchestration-Smart-Claims&demo_name=lakehouse-fsi-smart-claims&event=VIEW&path=%2F_dbdemos%2Flakehouse%2Flakehouse-fsi-smart-claims%2F04-Workflow-Orchestration%2F04-Workflow-Orchestration-Smart-Claims&version=1">
...
# MAGIC
# MAGIC Open the <a dbdemos-workflow-id="init-job" href="#job/992554426921401/tasks" target="_blank">FSI Smart Claims workflow</a> to start exploring Databricks orchestration capabilities!
