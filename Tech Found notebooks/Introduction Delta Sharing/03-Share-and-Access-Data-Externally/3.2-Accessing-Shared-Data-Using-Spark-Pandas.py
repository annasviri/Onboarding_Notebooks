...
# MAGIC %md
# MAGIC
# MAGIC The only config variable that we need in this demo is the *working_dir* path. We are going to use this path to download the credential file and save it into.
# MAGIC
