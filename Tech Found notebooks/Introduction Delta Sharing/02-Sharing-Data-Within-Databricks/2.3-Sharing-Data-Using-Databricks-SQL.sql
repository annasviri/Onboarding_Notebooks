...
-- MAGIC
-- MAGIC A sample dataset of flights data is created for you. **The table is  partitioned by `origin` field and Change Data Feed(CDF) is specified which will allow the recipient to query table data by version, starting from the current table version.**
-- MAGIC
