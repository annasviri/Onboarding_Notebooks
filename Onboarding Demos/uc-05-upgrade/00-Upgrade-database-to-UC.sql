...
-- MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=governance&org_id=1444828305810485&notebook=%2F00-Upgrade-database-to-UC&demo_name=uc-05-upgrade&event=VIEW&path=%2F_dbdemos%2Fgovernance%2Fuc-05-upgrade%2F00-Upgrade-database-to-UC&version=1">

-- COMMAND ----------

-- MAGIC %md 
-- MAGIC ### A cluster has been created for this demo
-- MAGIC To run this demo, just select the cluster `dbdemos-uc-05-upgrade-anna_sviridova` from the dropdown menu ([open cluster configuration](https://e2-demo-field-eng.cloud.databricks.com/#setting/clusters/1011-190832-8qb348wp/configuration)). <br />
