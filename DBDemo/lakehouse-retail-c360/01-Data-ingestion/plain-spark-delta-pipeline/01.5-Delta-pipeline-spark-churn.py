...
# MAGIC To run this demo, just select the cluster `dbdemos-lakehouse-retail-c360-anna_sviridova` from the dropdown menu ([open cluster configuration](https://e2-demo-field-eng.cloud.databricks.com/#setting/clusters/0926-090320-1h2zhx8z/configuration)). <br />
...
# MAGIC
# MAGIC
# MAGIC Switch to Databricks SQL to see how this data can easily be requested using <a  dbdemos-dashboard-id="churn-universal" href='/sql/dashboardsv3/01ef7be631661e2b9eee270316ed0439' target="_blank">Churn prediction DBSQL dashboard</a>, or an external BI tool. 
# MAGIC
