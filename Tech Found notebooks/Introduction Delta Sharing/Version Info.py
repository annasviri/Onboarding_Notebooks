...
# MAGIC
# MAGIC * Name: **Introduction to Delta Sharing**
# MAGIC * Version:  **Build**
# MAGIC * Built On: **Jul 13, 2023 at 13:08:31 UTC**
...
# MAGIC
# MAGIC This course is tested against and requires one of the following DBRs (Databricks Runtime): **12.2.x-scala2.12, 12.2.x-photon-scala2.12, 12.2.x-scala2.12, 12.2.x-photon-scala2.12**.
# MAGIC
